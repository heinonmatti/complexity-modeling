...
```{python, engine = "C:/Python27/python.exe"}
...
```{python 4.10, engine = "C:/Python27/python.exe"}
...
```{python 4.13-4.14-4.15, engine = "C:/Python27/python.exe"}
...
```{python ex4.8, engine = "C:\\Program Files\\Python36\\python.exe"}
...
```{python ex4.9-4.9, engine = "C:/Python27/python.exe"}
import sys
sys.path.append("C:/LocalData/hema/pythonLibs/") # this is the library you chose
...
```{python ex4.10-UNFINISHED, engine = "C:/Python27/python.exe"}
import sys
sys.path.append("C:/LocalData/hema/pythonLibs/") # this is the library you chose
