...
Constraining the covariance between Autonomous_T1 and BCTs_T1 leads to `Error in chol.default(S) : the leading minor of order 4 is not positive definite`.
...
d_Autonomous1 ~~  d_Autonomous1                     # This estimates the variance of the change scores
Autonomous_T1 ~~ c(autint, autint) * Autonomous_T1  # This estimates the variance of the Autonomous_T1 
Autonomous_T2 ~~ 0 * Autonomous_T2                  # This fixes the variance of the Autonomous_T2 to 0  

d_BCTs1 ~ 1                            # This estimates the intercept of the change score 
BCTs_T1 ~ c(autint, autint) * 1        # This estimates the intercept of BCTs_T1 
d_BCTs1 ~~ d_BCTs1                     # This estimates the variance of the change scores 
BCTs_T1 ~~ c(autint, autint) * BCTs_T1 # This estimates the variance of BCTs_T1 
...
Now, we constrain the parameters which ought to differ across intervention and control groups, to see if model fit changes.
...
Autonomous_T2 ~ 1 * Autonomous_T1       # This parameter regresses Autonomous_T2 perfectly on Autonomous_T1
d_Autonomous1 =~ 1 * Autonomous_T2      # This defines the latent change score factor as measured perfectly by scores on Autonomous_T2
d_Autonomous1 ~ c(autint, autint) * 1                     # This estimates the intercept of the change score 
Autonomous_T1 ~  c(autint, autint) * 1  # This constrains the intercept of Autonomous_T1 to be identical across intervention and control groups 
Autonomous_T2 ~ 0 * 1                   # This constrains the intercept of Autonomous_T2 to 0
...
We can see that model fit and out-of-sample prediction gets worse. Same happens when we constrain the change in BCTs, instead:
...
d_BCTs1 ~ c(autint, autint) * 1                            # This estimates the intercept of the change score 
BCTs_T1 ~ c(autint, autint) * 1        # This estimates the intercept of BCTs_T1 
d_BCTs1 ~~ d_BCTs1                     # This estimates the variance of the change scores 
BCTs_T1 ~~ c(autint, autint) * BCTs_T1 # This estimates the variance of BCTs_T1 
...
d_BCTs1 ~ Autonomous_T1 + BCTs_T1       # This estimates the COG to NEU coupling parameter and the COG to COG self-feedback
d_Autonomous1 ~ c(autint, autint) * BCTs_T1 + Autonomous_T1 # This estimates the NEU to COG coupling parameter and the NEU to NEU self-feedback
...
d_BCTs1 ~ c(autint, autint) * Autonomous_T1 + BCTs_T1       # This estimates the COG to NEU coupling parameter and the COG to COG self-feedback
d_Autonomous1 ~ BCTs_T1 + Autonomous_T1 # This estimates the NEU to COG coupling parameter and the NEU to NEU self-feedback
